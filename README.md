...
## 💼 Опыт работы:
### ⌛ 4+ года
- Работа с ORM, такими как Django-ORM и Tortoise-ORM, что позволяет мне создавать эффективные и масштабируемые backend-части приложений. 
Также умею настраивать и оптимизировать ORM для повышения производительности приложения.
- Работа с RAW SQL-запросами, что дает мне гибкость и возможность более тонкой настройки запросов и улучшения производительности приложения.
- Разработки backend-части приложений с нуля, что позволяет мне создавать эффективные, масштабируемые и безопасные backend-части приложений. 
Также знаком с модульным подходом и микросервисной архитектурой.
- Работа с Legacy-кодом, что позволяет мне легко читать, понимать и поддерживать код, написанный ранее другими разработчиками. 
Также умею вносить изменения в Legacy-код с минимальными рисками для проекта.
...
* Работа в команде: Опыт работы в командных проектах, где использовались Agile, Scrum и Kanban методологии. 
* Умею работать с людьми из разных культур и обеспечивать понимание между коллегами.
* Умение работать с информацией: Отлично ориентируюсь в больших объемах информации и умею быстро находить нужные данные.
...
* Успешный опыт менторства и наставничества, помогая коллегам и стажерам развиваться в своей профессиональной области. 
...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?color=%23000202&size=25&multiline=true&width=600&lines=%D0%98%D0%BD%D1%84%D0%BE%D1%80%D0%BC%D0%B0%D1%86%D0%B8%D1%8F+%D0%BE%D0%B1%D0%BD%D0%BE%D0%B2%D0%BB%D1%8F%D0%BB%D0%B0%D1%81%D1%8C+5+%D0%BC%D0%B0%D1%80%D1%82%D0%B0+2023+%D0%B3%D0%BE%D0%B4%D0%B0;.+.+.)](#кирилл-медведко)
